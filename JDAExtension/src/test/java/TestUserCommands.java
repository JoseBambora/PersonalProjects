...
public class TestUserCommands {
    ...
    public void testCommand() {
        ...
        GenericTests.testMessage(mockUserCommand.getResultMessage(true), true, mockUserCommand.getResultButtons(true), true, mockUserCommand.getResultFiles(true), false, mockUserCommand.getResultEmbed(true), false, "Hello", "SimpleMessage", Map.of("name", "teste"));
    }
    ...
    public void testCommandNoThinking() {
        ...
        mockUserCommand.execute();
        GenericTests.testMessage(mockUserCommand.getResultMessage(false), true, mockUserCommand.getResultButtons(false), true, mockUserCommand.getResultFiles(false), false, mockUserCommand.getResultEmbed(false), false, "Hello2", "SimpleMessage", Map.of("name", "teste"));
    }
}
