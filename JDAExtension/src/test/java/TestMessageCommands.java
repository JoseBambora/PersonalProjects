...
public class TestMessageCommands {
    ...
    public void testCommand() {
        ...
        GenericTests.testMessage(mockMessageCommand.getResultMessage(true), true, mockMessageCommand.getResultButtons(true), false, mockMessageCommand.getResultFiles(true), false, mockMessageCommand.getResultEmbed(true), false, "Hello", "SimpleMessage", Map.of("name", "teste"));
    }
    ...
    public void testCommandNoThinking() {
        ...
        mockMessageCommand.execute();
        GenericTests.testMessage(mockMessageCommand.getResultMessage(false), true, mockMessageCommand.getResultButtons(false), false, mockMessageCommand.getResultFiles(false), false, mockMessageCommand.getResultEmbed(false), false, "Hello", "SimpleMessage", Map.of("name", "teste"));
    }
}
