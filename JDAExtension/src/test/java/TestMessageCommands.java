...
public class TestMessageCommands {
    ...
    public void testCommand() {
        ...
        GenericTests.testMessage(mockMessageCommand.getResultMessage(true), "messagecontext",true, mockMessageCommand.getResultButtons(true), true, mockMessageCommand.getResultFiles(true), false, mockMessageCommand.getResultEmbed(true), false, "Hello", "SimpleMessage", Map.of("name", "teste"));
    }
    ...
    public void testCommandNoThinking() {
        ...
        mockMessageCommand.execute();
        GenericTests.testMessage(mockMessageCommand.getResultMessage(false), "messagecontext",true, mockMessageCommand.getResultButtons(false), true, mockMessageCommand.getResultFiles(false), false, mockMessageCommand.getResultEmbed(false), false, "Hello2", "SimpleMessage", Map.of("name", "teste"));
    }
}
